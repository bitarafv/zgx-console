...
const tabs = [
  { id: "simulation", number: "01", label: "Simulation Dashboard", icon: LayoutDashboard },
  { id: "node", number: "02", label: "ZGX Node", icon: Cpu },
  { id: "insights", number: "03", label: "Enterprise AI Insights", icon: GraduationCap },
  { id: "tco", number: "04", label: "TCO Calculator", icon: Calculator },
] as const;
