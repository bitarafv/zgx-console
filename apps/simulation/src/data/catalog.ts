...
const defs: Array<[string, string, Archetype, string, string, string]> = [
  ...
  ["financial-services", "Sovereign AML Operations", "workflow", "Financial-crime teams must triage high-volume transactions and document escalations without exposing sensitive data.", "Simulate a governed dual-engine path from transaction screening through human-reviewed FinCEN SAR drafting.", "Local AML intelligence"],
