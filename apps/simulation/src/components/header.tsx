...
export function Header() {
  ...
  return <header className="sticky top-0 z-40 border-b border-[var(--line)] bg-[color:var(--bg)]/80 backdrop-blur-xl">
    <div className="shell flex h-16 items-center gap-4">
      <Link href="/" className="flex items-center gap-3 font-black tracking-tight"><span className="grid size-8 place-items-center rounded-lg bg-blue-600 text-xs text-white">ZGX</span><span className="hidden sm:inline">EXPERIENCES</span></Link>
